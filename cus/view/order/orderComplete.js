...
var orderComplete = function (event, oCart, cOrderid, cOrderDate, cOrderTime) {
  event.source.profile().then(function (profile) {
    ...
    temp2.body.contents[4].contents[1].text = "name"
    temp2.body.contents[5].contents[1].text = "phone"
    ...
    for (var k = 0; k < i; k++) {
      ...
      var tempRe2 = lodash.cloneDeep(temp.store_temp.temp_acceptOrder_detail_repeat)
