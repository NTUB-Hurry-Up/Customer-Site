                    ...
                    if (data == -1) {
                        ...
                        for(var i = 0; i<data.length; i++){
                            ...
                            if(s != data[i].orderid){
                                ...
                                arr[0].contents.contents[scnt].body.contents[4].contents[1].text = (data[i].orderDate).getFullYear()+"-"+((data[i].orderDate).getMonth() + 1 < 10 ? '0' : '')+"-"+((data[i].orderDate).getDate() < 10 ? '0' : '')
                                arr[0].contents.contents[scnt].body.contents[4].contents[2].text = data[i].orderTime.substring(0,5)
                                arr[0].contents.contents[scnt].body.contents[5].contents[1].text = (data[i].takeDate).getFullYear()+"-"+((data[i].takeDate).getMonth() + 1 < 10 ? '0' : '')+"-"+((data[i].takeDate).getDate() < 10 ? '0' : '')
